...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/abrar-muhtasim/)
...
<table>
  <tr>
    <td align="center" width="25%">
      ...
      <sub>Zero hallucination in SEC filings & legal memos</sub>
    </td>
    <td align="center" width="25%">
      <h2>33%</h2>
  ...
  <tr>
    <td align="center" width="25%">
      ...
      <sub>SQL-backed metrics via conversational BI</sub>
    </td>
    <td align="center" width="25%">
      <h2>$0</h2>
    ...
    <td align="center" width="25%">
      ...
      <sub>Autonomous fact-checking & citation audit</sub>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <h4 align="center">Automated Case Law Retrieval, Statute Analysis & IRAC Memo Generation</h4>
      <p align="center">
        <a href="https://medium.com/@Abrarm/i-built-a-multi-agent-legal-ai-that-actually-doesnt-hallucinate-here-s-the-architecture-8c67a6a6f30d">
          <img src="https://img.shields.io/badge/Architecture_Article-12100E?style=for-the-badge&logo=medium&logoColor=white"/>
        </a>
      </p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <h4 align="center">Domain Fine-Tuned Phi-3-Mini (3.8B) on SEC Filings with Hallucination Resistance</h4>
      <p align="center">
        ...
        <a href="https://huggingface.co/Abrar144/sec-assistant-phi3-finqa">
          <img src="https://img.shields.io/badge/Model_Weights-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black"/>
        </a>
      </p>
      <p>
      ...
      <ul>
        ...
        <li><strong>Contrasting Dataset Design:</strong> Curated 70/30 matched vs. adversarial mismatched contexts to explicitly teach the model boundary-awareness.</li>
        <li><strong>100% Citation Compliance:</strong> Boosted citation inclusion rate from 80% to 100% via structured prompt schemas.</li>
        <li><strong>100% Matched Context Answer Rate:</strong> Maintained perfect answer fidelity on matched contexts while preserving strict refusal on out-of-context queries.</li>
      </ul>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li><strong>24 Standardized KPIs:</strong> RevPAR, ADR, Occupancy Rate, Cancellation Rate, and Channel Mix calculated with deterministic consistency.</li>
        <li><strong>4-Layer Anomaly Detection:</strong> Evaluates property-level metric deviations against historical baselines and generates executive alerts.</li>
        <li><strong>Unified Data Engine:</strong> Synchronized Streamlit front-end and conversational agent over a single Supabase PostgreSQL backend.</li>
      </ul>
      <p>
        <code>LiteLLM</code> <code>OpenRouter</code> <code>PostgreSQL</code> <code>Supabase</code> <code>Streamlit</code> <code>Plotly</code> <code>Python</code>
      </p>
    </td>
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li><strong>Severity Triage Engine:</strong> Categorizes incidents by severity score and routes high-priority churn indicators to operational queues.</li>
        <li><strong>Automated Synthesis:</strong> Aggregates recurrent friction points into weekly executive summaries and product backlog recommendations.</li>
      </ul>
      <p>
        <code>Python</code> <code>NLP</code> <code>LLM Agent</code> <code>Pandas</code> <code>Workflow Automation</code>
      </p>
    </td>
  </tr>
</table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p align="center">
        ...
        <a href="https://credit-risk-underwriting-portal.onrender.com">
          <img src="https://img.shields.io/badge/Live_Cloud_App-46E3B7?style=for-the-badge&logo=render&logoColor=white"/>
        </a>
        <a href="https://huggingface.co/spaces/Abrar144/credit-risk-underwriting-engine">
          <img src="https://img.shields.io/badge/HF_Interactive_Space-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black"/>
        </a>
        <a href="https://colab.research.google.com/github/AbrarMuhtasim14/credit-risk-modelling/blob/main/notebooks/credit_risk_standalone_pipeline.ipynb">
          <img src="https://img.shields.io/badge/Colab_Benchmark-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white"/>
        </a>
      </p>
      <p>
      ...
      <ul>
        ...
        <li><strong>Strict Temporal Validation:</strong> Trained on 2018–2019 applications and evaluated on 2020 Out-Of-Time (OOT) test data, ensuring zero data leakage and resilience to macroeconomic shifts.</li>
        <li><strong>33% Loss Reduction:</strong> Proved that 10:1 cost-sensitive XGBoost preserves ROC-AUC (0.7588 → 0.7589 OOT) while reducing portfolio default losses by ~33% ($18.6M estimated savings).</li>
        <li><strong>Regulatory Compliance (GDPR Art. 22 / US FCRA):</strong> Integrated SHAP waterfall explanations to generate defensible Adverse Action notices for rejected applicants.</li>
        <li><strong>Live Production Deployment:</strong> Containerized and deployed as an interactive underwriting simulator with real-time risk scoring, pricing tiers, and stress testing on Render and Hugging Face.</li>
      </ul>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p align="center">
        ...
        <a href="https://hotel-cancellation-engine.onrender.com">
          <img src="https://img.shields.io/badge/Live_Cloud_App-46E3B7?style=for-the-badge&logo=render&logoColor=white"/>
        </a>
        <a href="https://huggingface.co/spaces/Abrar144/hotel-cancellation-risk-engine">
          <img src="https://img.shields.io/badge/HF_Interactive_Space-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black"/>
        </a>
        <a href="https://medium.com/@Abrarm/a-python-data-analysis-project-to-understand-hotel-cancellations-fb3f0fee6eea">
    ...
    <td width="50%" valign="top">
      ...
      <p align="center">
        ...
        <a href="https://github.com/AbrarMuhtasim14/Real-Estate-Data-Cleaning-in-SQL">
          <img src="https://img.shields.io/badge/SQL_Portfolio-181717?style=for-the-badge&logo=github&logoColor=white"/>
        </a>
      </p>
      <p>
      ...
      <p>
        <code>Advanced SQL</code> <code>PostgreSQL</code> <code>BigQuery</code> <code>Funnel Analysis</code> <code>E-Commerce Analytics</code>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        Customer behavioral clustering and retention cohort analysis evaluating lifetime value, repeat purchase velocity, and churn susceptibility in retail commerce.
      </p>
      <ul>
...
<p><strong>Deployment, Cloud & Automation</strong></p>
...
<table>
  <tr>
    <td valign="top">
      ...
      <ul>
        <li>Administered enterprise master data systems in <strong>Microsoft 365 Dynamics</strong>, ensuring high data fidelity, schema conformance, and operational integrity across business-critical supply chain records.</li>
        <li>Collaborated with engineering, merchandising, and financial stakeholders to design and enforce data governance protocols, eliminating cross-departmental data anomalies.</li>
        <li>Translated operational supply chain challenges into automated data validation routines, establishing the foundational discipline for building reliable, production-ready AI/ML systems.</li>
      </ul>
    </td>
  </tr>
</table>
...
- **Data Analyst Career Track** — 365 Data Science
- **Data Science using Python A-Z for Machine Learning** — Udemy
...
- **Hierarchical Multi-Agent Systems:** Evaluating DAG-based task delegation and consensus protocols across multi-agent swarms.
- **Production Memory Architectures:** Designing long-horizon conversational memory layers combining episodic vector stores with deterministic relational state caches.
- **Cost-Sensitive Risk Modeling:** Extending cost-sensitive objective functions to real-time credit card fraud detection and healthcare survival analysis.
- **Enterprise Agentic Automation:** Bridging agentic LLM tool execution with secure enterprise webhook workflows via n8n.
...
**Actively open to Agentic AI Engineer, LLM Engineer, Applied Machine Learning, and Data & BI roles**
...
![Footer](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=120&section=footer&text=Agentic%20AI%20%7C%20Applied%20Machine%20Learning%20%7C%20Data%20Intelligence&fontSize=20&fontColor=fff&animation=twinkling&fontAlignY=70)
